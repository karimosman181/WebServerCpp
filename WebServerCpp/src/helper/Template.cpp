...
std::string Template::processTemplate(const std::string& content, const Json::Value context) {
    ...
    while (it != end) {
        ...
        result.replace(result.find(matched_string), matched_string.length(), replacement);
    ...
    while (it_each != end) {
        ...
        std::string matched_string = match.str();
        result.replace(result.find(matched_string), matched_string.length(), loopResult);
    ...
    while (it_var != end_var) {
        ...
        //result.replace(result.find(matched_string), matched_string.length() - 1, replacement);
